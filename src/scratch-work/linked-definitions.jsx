...
const linkedDefinitions = {
  ...
  "difficulty bomb": {
    "definition": "The <Link to="difficulty">difficulty</Link> bomb, along with the <Link to="Beacon Chain">Beacon Chain</Link> and others, was a key element of <Link to="Ethereum">Ethereum</Link>'s <Link to="upgrade">upgrade</Link> to <Link to="Ethereum">Ethereum</Link> 2.0 and a Proof of Stake (PoS) <Link to="consensus">consensus</Link> mechanism. As the name indicates, the <Link to="difficulty">difficulty</Link> bomb was a software mechanism that increased block verification <Link to="difficulty">difficulty</Link>, making it more expensive and difficult--eventually, prohibitively so--to mine a new block. Through economic incentive, and later, the raw limitations of computing power, this forced the shift to PoS <Link to="consensus">consensus</Link>. See also 'Proof of Stake', 'the Merge'."
  },
  "digital asset": {
  ...
  "Merge (noun)": {
    "definition": "Finalized in September 2022, the Merge was the culmination of years of work involved in transitioning <Link to="Ethereum">Ethereum</Link> from a Proof of Work <Link to="consensus">consensus</Link> model, to Proof of Stake, all while keeping the <Link to="network">network</Link> live. This was successful, and reduced the <Link to="network">network</Link>’s carbon footprint by more than 99.9%."
  },
  ...
  "upgrade": {
    "definition": "Upgrading is the process of replacing a product with a newer version of the same product. In computing and consumer electronics, an <Link to="upgrade">upgrade</Link> is generally a replacement of hardware, software, or firmware with a newer or better version, in order to bring the system up to date or to improve its characteristics. See also EIP-1159, merge, and  other important <Link to="Ethereum">Ethereum</Link> upgrades"
  },
  "UTXO": {
