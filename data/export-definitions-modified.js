...
,
    "termCategory": "Brand or project name",
    "i18n": {
...
,
  ...
  "address/\"public address\" (wallet address)": {
    "term": "address/\"public address\" (wallet address)",
    "phonetic": "",
    "partOfSpeech": "",
    "description": (
  <>
...
Advanced gas controls\": it is an optional feature in the MetaMask wallet,  that gives you more control over the gas you pay in MetaMask.\n\nUsing advanced gas controls",
...
gas fees\", Aggressive is a category that enables you to be more forceful with your transaction, and have it completed as soon as possible. There are three categories available in MetaMask: Low, Market, Aggressive\n\nUsing advanced gas controls",
    "termCategory": "MetaMask term",
    "i18n": {
...
,
  ...
  "API (Application Programming Interface)": {
    ...
    "description": (
  <>
    A predefined set of requests that one program can make to another in order to transfer information between them. When you hear someone saying that an application is \
  </>
)
getting information from\" another source, it's often doing so through an API.",
    "termCategory": "Software term",
    "i18n": {
  ...
  "AppChain": {
    ...
    "description": (
  <>
    A blockchain network custom-made and optimized for a specific application's needs. An appchain is generally not a full-blown blockchain, but offers an optimized execution environment for the application, while still relying on an underlying blockchain for consensus. See also: \
  </>
)
blockchain trilemma\", \"modular blockchain\", \"Layer 2\", \"Layer 3\".",
    "termCategory": "Blockchain term",
    "i18n": {
...
,
    ...
    "i18n": {
      ...
      "Korean": "ASIC(주문형 반도체)",
      "Persian": "ای‌سیک(مدارهای مجتمع با کاربرد خاص)",
...
,
  ...
  "Blockchain explorer": {
    ...
    "description": (
  <>
    A blockchain explorer is an application, most often a website along with a corresponding API, that displays information about blockchain activity in a more human-friendly way. While a blockchain is designed to keep information forever, and be \
  </>
)
readable by anyone\", finding the specific information you're interested in may require indexing data off the blockchain--that is, sorting it according to given categories (sender address, token type, etc) into a separate database which can then be queried by the user; this essential function is provided by blockchain explorers. A prominent example is etherscan, which also offers explorers on a number of other networks.",
    "termCategory": "Blockchain term",
    "i18n": {
...
low-level\" computer language, that is, meant to be processed by a computer, rather than a \"high-level\", more human-readable, language. In Ethereum, higher-level Solidity is compiled into Ethereum bytecode, which is read by the Ethereum Virtual Machine (EVM).",
    "termCategory": "Brand or project name",
    "i18n": {
...
hard fork\" in the Ethereum network that occurred in October of 2017. For detailled information, see here; see also \"hard fork\".",
    "termCategory": "Software term",
    "i18n": {
...
,
    ...
    "i18n": {
      ...
      "Persian": "کلاینت (اتریوم یا سایر بلاک‌چین‌های سازگار)",
...
,
    ...
    "i18n": {
      ...
      "Persian": "کیف پول سرد/رذخیره‌سازی سرد",
...
hard forks\" made to the Ethereum network, in February 2019. For more detailed information, see here; see also \"hard fork\".",
    "termCategory": "Blockchain term",
    "i18n": {
...
,
  ...
  "crypto-": {
    ...
    "description": (
  <>
    Even though this prefix is originally Greek, our current usage comes from cryptography. Technologies that are referred to with the blanket term of \
  </>
)
crypto\" tech are underlain by cryptographic tools and processes (such as public/private key pairs) that enable innovative functionality and security. Of course, \"cryptocurrency\" often gets shortened to simply \"crypto\", so this emerging field is full of instances where something \"crypto\" is being added to or shortened. With the emergence of the term \"Web3\", arguably a distinction has begun to be made between \"crypto\", referring to DeFi and other financial use cases of the technology, while \"Web3\" refers to the transition of Internet-based activities to more decentralized practices and platforms.",
    "termCategory": "Ecosystem term",
    "i18n": {
...
,
    ...
    "i18n": {
      ...
      "Italian": "cryptoasset",
      "Korean": "암호 자산",
      "Persian": "دارایی‌های رمزنگاری شده",
...
,
    ...
    "i18n": {
      ...
      "Hindi": "डीसेंट्रलाइज्ड ऑटोनोमस ऑर्गेनाईज़ेशन (DAO)",
...
,
    ...
    "i18n": {
      ...
      "Persian": "کنفرانس توسعه‌دهندگان اتریوم",
...
,
  ...
  "Digital signature": {
    ...
    "description": (
  <>
    A short string of data a user produces for a document using a private key such that anyone with the corresponding public key, the signature, and the document can verify that (1) the document was \
  </>
)
signed\" by the owner of that particular private key, and (2) the document was not changed after it was signed.",
    "termCategory": "Blockchain term",
    "i18n": {
...
,
    ...
    "i18n": {
      ...
      "Persian": "حمله محروم‌سازی از سرویس (دیداس)",
...
,
    ...
    "i18n": {
      ...
      "Korean": "분산 원장 기술",
      "Persian": "فناوری دفترکل توزیع‌شده",
...
distributed ledger technology\".",
  ...
  "double spend": {
    ...
    "description": (
  <>
    The 'double spend' is the benchmark security concern of blockchain networks: how do we ensure that someone doesn't send the same transaction to two different entities, essentially \
  </>
)
spending their money twice\"? This is the cornerstone of the consensus mechanism, ensuring that all nodes of the network are \"in agreement\" about which assets are allocated to which addresses, on an ongoing basis, to prevent malicious actions such as a double spend.",
    "termCategory": "Blockchain term",
    "i18n": {
...
web3 ecosystem\"; \"blockchain ecosystem\". See \"web3\"; See \"blockchain",
    "termCategory": "Blockchain term",
    "i18n": {
...
Edge computing\": it is an emerging computing paradigm which refers to a range of networks and devices at or near the user. Edge is about processing data closer to where it's being generated, enabling processing at greater speeds and volumes, leading to greater action-led results in real time.\nThe term can also refer to Microsoft's browser or the crypto software wallet",
    "termCategory": "Blockchain term",
    "i18n": {
...
crypto\" tech in general. In MetaMask, an unencrypted private key is 64 characters long, and it is used to unlock or restore wallets. An encrypted key is also 64 letters long and is a regular private key that has gone through the process of encryption. Usually, encrypted private keys are kept within the extension or device they are encrypted by, and they remain out of sight from the user. This is meant to add another layer of security to keep a user’s wallet information safe. By way of example: if the world ‘Apple’ was your private key, then it was encrypted three letters down the alphabet, your new encrypted key would be ‘Dssoh’. Since you know the way to encrypt this key, you could derive the original private key from it by reversing the method of encryption.",
    ...
    "i18n": {
      ...
      "Hindi": "एन्क्रिप्टेड बनाम अनएन्क्रिप्टेड कीज़ (keys)",
...
,
    ...
    "i18n": {
      ...
      "Hindi": "एंटरप्राइज़ एथेरियम एलायंस (EEA)",
...
,
    ...
    "i18n": {
      ...
      "Persian": "پروتکل‌های بهبود اتریوم (EIP)",
      ...
      "Hindi": "एथेरियम इम्प्रूवमेंट प्रपोज़ल (EIP)",
...
private key\"; see \"Hierarchical Deterministic (HD)\" wallet. An extended private key, or xprv, is a private key which can be used to derive child private keys as part of a Hierarchical Deterministic (HD) wallet.",
    "termCategory": "Ecosystem term",
    "i18n": {
...
public key\"; see \"Hierarchical Deterministic (HD)\" wallet. An extended public key, or xpub, is a public key which can be used to derive child public keys as part of a Hierarchical Deterministic (HD) wallet.",
    "termCategory": "Blockchain term",
    "i18n": {
...
,
  ...
  "hard fork": {
    ...
    "description": (
  <>
    A hard fork occurs when there is a change in the blockchain that is not backward compatible (not compatible with older versions), thus requiring all participants to upgrade to the new version in order to be able to continue participating on the network. See also \
  </>
)
fork\".",
    "termCategory": "Blockchain term",
...
,
  ...
  "Hierarchical Deterministic (HD) wallet": {
    ...
    "description": (
  <>
    Hierarchical Deterministic wallets were first created for Bitcoin, and enable the creation of a very large number of accounts based on an initial seed phrase. This technology was later adopted in Ethereum wallets; when restoring a MetaMask wallet from the Secret Recovery Phrase, for example, if you \
  </>
)
create\" accounts, they will be the same accounts as previously created from that same phrase; they are derived from it.",
    "termCategory": "Blockchain term",
    "i18n": {
...
,
    ...
    "i18n": {
      ...
      "Persian": "فایل سیستم بین سیاره‌ای (IPFS)",
...
,
    ...
    "i18n": {
      ...
      "Korean": "고객거래확인",
      "Persian": "شناسایی مبدأ تراکنش‌ها",
...
scaling solutions\" while not being part of Ethereum's protocol-level scaling efforts. See also \"blockchain trilemma\", \"modular blockchain\", \"Serenity\". Contrast with \"sidechain\".",
    "termCategory": "Ecosystem term",
    "i18n": {
...
gas fees\", Low is a category that allows you to wait a bit longer and save money if you choose. There are 3 categories available in MetaMask: Low, Market, Aggressive\n\nUsing Advanced Gas Controls",
    "termCategory": "Ecosystem term",
    "i18n": {
...
miner tip\", goes to the validator or miner, and incentivizes them to prioritize your transaction.",
    "termCategory": "Software term",
    "i18n": {
...
NFT metadata\": Metadata is \"data that provides information about other data\" Metadata",
    "termCategory": "Ecosystem term",
    "i18n": {
...
,
    ...
    "i18n": {
      ...
      "Hindi": "MetaMask कम्युनिटी प्लेटफ़ॉर्म",
...
,
    ...
    "i18n": {
      ...
      "Korean": "MetaMask SDK",
      "Persian": "کیت توسعه نرم‌افزار متامسک",
...
,
  ...
  "Nested Blockchain": {
    ...
    "description": (
  <>
    A nested blockchain is essentially a blockchain within — or, rather, atop — another blockchain. See \
  </>
)
Layer 2",
    "termCategory": "Ecosystem term",
...
,
  ...
  "on-ramp, off-ramp": {
    ...
    "description": (
  <>
    Based on a metaphor from the American highway system, \
  </>
)
...
,
  ...
  "Polygon": {
    ...
    "description": (
  <>
    Polygon (formerly Matic Network) is a layer-2 scaling solution for Ethereum that aims to address the scalability issues of the Ethereum blockchain. It is designed to provide faster and cheaper transactions with the same level of security and decentralization as the Ethereum network.\n\nPolygon achieves this by creating a multi-chain ecosystem that is built on top of the Ethereum network. This ecosystem consists of various interconnected sidechains that can process transactions independently of the main Ethereum blockchain. These sidechains are called \
  </>
)
Polygon chains\" or \"commit chains\".",
    "termCategory": "Ecosystem term",
    "i18n": {
...
public key\",see \"Cryptography\", see \"blockchain\". Public-Key Cryptography",
    "termCategory": "Blockchain term",
    "i18n": {
...
,
  ...
  "Software Development Kit (SDK)": {
    ...
    "description": (
  <>
    A software development kit is a collection of software development tools in one installable package. They facilitate the creation of applications by having a compiler, debugger and sometimes a software framework. See \
  </>
)
MetaMask SDK",
    "termCategory": "MetaMask term",
    "i18n": {
      ...
      "Persian": "کیت توسعه نرم‌افزار (SDK)",
...
,
  ...
  "transaction pool": {
    ...
    "description": (
  <>
    When a user submits a transaction to the Ethereum network--or many other networks based on Ethereum--the transaction goes into what's know as a \
  </>
)
transaction pool\", or \"txpool\" for short. This is essentially a queue of transactions that are waiting to be added to a block and recorded to the blockchain. There are mechanisms that determine which transactions are \"picked up\" and included in the next block, and there is currently a lot of research surrounding how this decision gets made (see \"MEV\"). In Bitcoin, the transaction pool was referred to as the \"memory pool\", or \"mempool\", and often these terms are used interchangeably.",
    "termCategory": "Blockchain term",
    "i18n": {
...
,
  ...
  "Two-Factor Authentication (2FA)": {
    ...
    "description": (
  <>
    Two-factor authentication (2FA) is an identity and access management security method that requires two forms of identification to access resources and data. 2FA gives businesses the ability to monitor and help safeguard their most vulnerable information and networks.See also \
  </>
)
U2F\" When 2FA",
    "termCategory": "Ecosystem term",
...
,
    ...
    "i18n": {
      ...
      "Persian": "خروجی خرج‌نشده تراکنش (UTXO)",
...
vesting period\": The act of restricting the sale of a token for a particular period of time. Vesting period",
    "termCategory": "Blockchain term",
    "i18n": {
      ...
      "Italian": "Vesting",
      "Korean": "베스팅",
      "Persian": "توزیع برنامه‌ریزی شده توکن",
  ...
  "wallet": {
    ...
    "description": (
  <>
    In Ethereum-based blockchain technology, a 'wallet' is a something that allows you to manage private keys, your Secret Recovery Phrase, and the accounts generated from it. This could be an internet-connected 'hot wallet', like MetaMask, or an 'airgapped' hardware wallet. In more technical speak, you could say \
  </>
)
the wallet is the client, not the keys.\" It is very common for people to use the word 'wallet' to refer to their SRP itself, or the accounts generated from it, or even to one account.",
    "termCategory": "MetaMask term",
    "i18n": {
...
,
    ...
    "i18n": {
      ...
      "Korean": "영지식 롤업",
      "Persian": "رول‌آپ‌ بی‌نیاز به دانش",
...
,
    ...
    "i18n": {
      ...
      "Korean": "영지식 스나크",
      "Persian": "گواه‌های اثبات دانش صفر غیرتعاملی",
